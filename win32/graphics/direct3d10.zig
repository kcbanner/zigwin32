...
pub const D3D10_FLOAT16_FUSED_TOLERANCE_IN_ULP = @as(f64, 0.6);
pub const D3D10_FLOAT32_MAX = @as(f32, 340282350000000000000000000000000000000);
pub const D3D10_FLOAT32_TO_INTEGER_TOLERANCE_IN_ULP = @as(f32, 0.6);
pub const D3D10_FLOAT_TO_SRGB_EXPONENT_DENOMINATOR = @as(f32, 2.4);
pub const D3D10_FLOAT_TO_SRGB_EXPONENT_NUMERATOR = @as(f32, 1);
pub const D3D10_FLOAT_TO_SRGB_OFFSET = @as(f32, 0.055);
pub const D3D10_FLOAT_TO_SRGB_SCALE_1 = @as(f32, 12.92);
pub const D3D10_FLOAT_TO_SRGB_SCALE_2 = @as(f32, 1.055);
pub const D3D10_FLOAT_TO_SRGB_THRESHOLD = @as(f32, 0.0031308);
pub const D3D10_FTOI_INSTRUCTION_MAX_INPUT = @as(f32, 2147483600);
pub const D3D10_FTOI_INSTRUCTION_MIN_INPUT = @as(f32, -2147483600);
pub const D3D10_FTOU_INSTRUCTION_MAX_INPUT = @as(f32, 4294967300);
...
pub const D3D10_MAX_POSITION_VALUE = @as(f32, 34028236000000000000000000000000000);
...
pub const D3D10_MIP_LOD_BIAS_MAX = @as(f32, 15.99);
...
pub const D3D10_MULTISAMPLE_ANTIALIAS_LINE_WIDTH = @as(f32, 1.4);
...
pub const D3D10_PS_PIXEL_CENTER_FRACTIONAL_COMPONENT = @as(f32, 0.5);
...
pub const D3D10_SRGB_GAMMA = @as(f32, 2.2);
pub const D3D10_SRGB_TO_FLOAT_DENOMINATOR_1 = @as(f32, 12.92);
pub const D3D10_SRGB_TO_FLOAT_DENOMINATOR_2 = @as(f32, 1.055);
pub const D3D10_SRGB_TO_FLOAT_EXPONENT = @as(f32, 2.4);
pub const D3D10_SRGB_TO_FLOAT_OFFSET = @as(f32, 0.055);
pub const D3D10_SRGB_TO_FLOAT_THRESHOLD = @as(f32, 0.04045);
pub const D3D10_SRGB_TO_FLOAT_TOLERANCE_IN_ULP = @as(f32, 0.5);
...
pub const D3D_SPEC_VERSION = @as(f64, 1.050005);
...
pub const D3D10_1_FLOAT16_FUSED_TOLERANCE_IN_ULP = @as(f64, 0.6);
pub const D3D10_1_FLOAT32_TO_INTEGER_TOLERANCE_IN_ULP = @as(f32, 0.6);
